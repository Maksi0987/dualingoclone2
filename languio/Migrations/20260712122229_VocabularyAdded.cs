...
{
    /// <inheritdoc />
    public partial class VocabularyAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveLangeageCourseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ActiveLangeageCourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VocabularyWordId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Groups_Courses_LanguageCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguageLessonGroupId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.LanguageLessonGroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptinsRaw = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LanguageLessonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_LanguageCourseId",
                table: "Groups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_LanguageLessonGroupId",
                table: "Lessons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_LanguageLessonId",
                table: "Questions",
